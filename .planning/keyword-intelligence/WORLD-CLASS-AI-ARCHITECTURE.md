...
> **Generated:** 2026-04-26 (Updated with April 2026 pricing)
...
|------|------------|-----|----------------|
| **Fast pre-filter** | **Grok 4.1 Fast** | Cheapest capable, 2M context | $0.20 in / $0.50 out |
| **Classification** | Grok 4.1 Fast or Gemini 3.1 Flash Lite | Best price/quality | $0.20-0.25 in |
| **Lithuanian content** | GPT-5.4 | Best Baltic language support | $1.75 in / $14.00 out |
...
**Cost projection:** $1-3/month for 100K keywords (with optimization)
...
└─────────────────────────────────────────────────────────────────────────────┘
                                       ...
                                       ▼
┌─────────────────────────────────────────────────────────────────────────────┐
│  PASS 1: FAST CLASSIFICATION (Grok 4.1 Fast)                 COST: ~$0.15   │
│  ─────────────────────────────────────────────────────────────────────────  │
│  • Binary classification: LIKELY_RELEVANT | NEEDS_REVIEW                    │
│  • $0.20/$0.50 per 1M tokens - CHEAPEST capable model                       │
│  • 2M context window - fits entire business profile + all keywords          │

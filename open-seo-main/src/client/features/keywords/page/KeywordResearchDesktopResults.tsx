...
function DesktopTableCard({ controller }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 border border-border rounded-xl bg-background overflow-hidden">
  ...
  return (
    <div className="shrink-0 flex items-center gap-3 px-4 py-2 border-b border-border bg-background text-xs-safe text-muted-foreground font-medium">
      <Checkbox
        ...
        onCheckedChange={controller.toggleAllRows}
      />
      <SortHeader
        label="Keyword"
        field="keyword"
  ...
  return (
    <div className="order-1 xl:order-2 flex flex-col min-w-0 gap-2 xl:flex-1">
      {overviewKeyword && overviewKeyword.trend.length > 0 ? (
        <div className="shrink-0 border border-border rounded-xl bg-background px-4 py-3">
      ...
      <div className="flex-1 flex flex-col overflow-hidden border border-border rounded-xl bg-background">

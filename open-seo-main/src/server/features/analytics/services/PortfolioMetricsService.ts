...
export class PortfolioMetricsService {
  ...
  async getPortfolioSummary(
    ...
    try {
      ...
      console.error('[PortfolioMetricsService] getPortfolioSummary failed:', {
  ...
  async getPortfolioTrends(
    ...
    try {
      ...
      console.error('[PortfolioMetricsService] getPortfolioTrends failed:', {
        method: 'getPortfolioTrends',
        params: { workspaceId, period, dateRange },
        error: error instanceof Error ? error.message : 'Unknown error',
      });
      throw new Error(`Failed to get portfolio trends: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
  ...
  async getTopPerformingClients(
    ...
    try {
      ...
      console.error('[PortfolioMetricsService] getTopPerformingClients failed:', {
        method: 'getTopPerformingClients',
        params: { workspaceId, limit },
        error: error instanceof Error ? error.message : 'Unknown error',
      });
      throw new Error(`Failed to get top performing clients: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
  ...
  async getUnderperformingClients(
    ...
    try {
      ...
      console.error('[PortfolioMetricsService] getUnderperformingClients failed:', {
        method: 'getUnderperformingClients',
        params: { workspaceId, limit },
        error: error instanceof Error ? error.message : 'Unknown error',
      });
      throw new Error(`Failed to get underperforming clients: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
  ...
  async getClientComparison(workspaceId: string): Promise<ClientComparison[]> {
    try {
      ...
      console.error('[PortfolioMetricsService] getClientComparison failed:', {
        method: 'getClientComparison',
        params: { workspaceId },
        error: error instanceof Error ? error.message : 'Unknown error',
      });
      throw new Error(`Failed to get client comparison: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
}

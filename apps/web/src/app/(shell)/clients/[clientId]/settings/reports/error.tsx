...
export default function ReportSettingsError({
  ...
  useEffect(() => {
    console.error('[ReportSettingsError]', {
      digest: error.digest,
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] gap-4 p-8">
      ...
      <h2 className="text-xl font-semibold">Unable to load report settings</h2>
      <p className="text-muted-foreground text-center max-w-md">
        We encountered an error loading the report settings. Please try again.
      </p>
      {error.digest && (
